...
const ProfileCard = ({ user }) => {
  ...
  return (
    <div className="flex items-center w-full justify-center relative top-1/2 lg:top-1/4">
      <div className="max-w-xs">
        <div className="bg-[#b1aeae8c] shadow-xl rounded-lg w-[280px] lg:w-[300px] h-80">
