    ...
    <div className="">
      <article className="rounded-md bg-[#191825] lg:p-4 p-4 lg:w-[450px] w-72 min-w-full lg:h-[320px] h-[320px]">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h3 className="text-base tracking-tight lg:text-lg font-medium text-white">
              {userName}
            </h3>
        ...
        <ul className="mt-4 space-y-2">
          <li>
            ...
            <p className="h-[110px] scrollbar-thumb-slate-100 scrollbar-track-[#A09B9D] scrollbar-track-rounded-md scrollbar-thumb-rounded-md scrollbar-thin mt-1 text-base font-medium text-gray-200 rounded-md border border-gray-700 p-2 hover:border-pink-600">
              {message}
            </p>
          </li>
        </ul>
